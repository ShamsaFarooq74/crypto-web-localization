				...
				<div class="card mb-5 mb-xl-8">
					...
					<div class="card-header border-0 pt-5">
						<h3 class="card-title align-items-start flex-column">
							<span class="card-label fw-bolder fs-3 mb-1">Terms And Conditions</span>

						</h3>
						<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top"
						data-bs-trigger="hover">
						<a href="{{ route('term.create') }}" class="btn btn-sm btn-light btn-active-primary">
						...
						<!--end::Svg Icon-->Create Terms And Conditions
					</a>
				</div>
			</div>
			<!--end::Header-->
					...
					<table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<p class="text-dark fw-bolder text-hover-primary d-block fs-6 ">
										{{ substr($term->descriptionEN, 0, 12) . '...' }}
									</p>
								</td>
								<td>
									<p class="text-dark fw-bolder text-hover-primary d-block fs-6 ">
										{{ substr($term->descriptionAR, 0, 12) . '...' }}
									</p>
								</td>
								...
								<td>
									...
									<form action="{{ route('term.edit', $term->id) }}" method="post">
										@csrf
										@method('GET')
										<button type="submit"
							...
							<form action="{{ route('term.destroy', $term->id) }}"
