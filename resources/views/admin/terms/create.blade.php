        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item " aria-current="page">Create Terms</li>
                </ol>
            </nav>
        </div>
        <!--end::Container-->
                    ...
                    <div class="col-md-8 mx-auto">
                        <form action="{{ route('term.store') }}" method="post">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="titleEN" value="{{ old('titleEN') }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="titleAR" value="{{ old('titleAR') }}"
