        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item " aria-current="page">Edit Term</li>
                </ol>
            </nav>
        </div>
        <!--end::Container-->
                    ...
                    <div class="col-md-8 mx-auto">
                        <form action="{{ route('term.update', $term->id) }}" method="post">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="titleEN" value="{{ $term->titleEN }}"
                                class="form-control mb-3" placeholder="Enter  titleEN">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="titleAR" value="{{ $term->titleAR }}"
                                class="form-control mb-3" placeholder="Enter titleAR">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                placeholder="Enter DescriptionEN">{{ $term->descriptionEN }}</textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                placeholder="Enter DescriptionAR">{{ $term->descriptionAR }}</textarea>
                                <div class="d-flex justify-content-center my-3">
