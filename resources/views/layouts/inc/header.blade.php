...
<div class="d-flex align-items-stretch flex-shrink-0">
    ...
    <div class="topbar d-flex align-items-stretch flex-shrink-0">
        ...
        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            ...
            <img alt="Pic"
            src="{{ asset('assets/uploads/profile_pics/' . auth()->user()->profile_pic) }}" />
            @else
            <img alt="Pic" src="{{ asset('assets/media/logos/profile_image.png') }}" />
            @endif
        </div>
        <!--begin::Menu-->
        ...
        <div class="menu-item px-3">
            <div class="menu-content d-flex align-items-center px-3">
                ...
                <div class="symbol symbol-50px me-5">
                    ...
                    @else
                    <img alt="Logo"
                    src="{{ asset('assets/media/logos/profile_image.png') }}" />
                    @endif
                </div>
                <!--end::Avatar-->
                <!--begin::Username-->
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-5">
            <form action="{{ route('logout-user') }}" id="myform" method="Post">
                @csrf
                <a onclick="document.getElementById('myform').submit()" class="menu-link px-5">Sign
                Out</a>
            </form>
        </div>
        <!--end::Menu item-->
        ...
        <div class="menu-item px-5">
            <div class="menu-content px-5">
                ...
                <input class="toggle-class form-check-input w-30px h-20px" type="checkbox"
                data-id={{ auth()->user()->id }}
                {{ auth()->user()->status == 1 ? 'checked' : '' }} name="user_id" />
